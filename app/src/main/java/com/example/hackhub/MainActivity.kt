    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navView.setNavigationItemSelectedListener {
            ...
            when (it.itemId) {
                ...
                R.id.nav_File_Bruteforce -> Toast.makeText(
                    applicationContext,
                    "Clicked File Bruteforce",
                    Toast.LENGTH_SHORT
                ).show()
                R.id.nav_IP_Sweeper -> Toast.makeText(
                    applicationContext,
                    "Clicked IP Sweeper",
                    Toast.LENGTH_SHORT
                ).show()
                R.id.nav_new2 -> Toast.makeText(
                    applicationContext,
                    "Clicked new2",
                    Toast.LENGTH_SHORT
                ).show()
                R.id.nav_new3 -> Toast.makeText(
                    applicationContext,
                    "Clicked new3",
                    Toast.LENGTH_SHORT
                ).show()
